...
CCC
    ...
    4)
        ...
        ;;
    5)
        create_res_1 3000x2000 2880x1920 2700x1800 2560x1707 2400x1600 2250x1500 1920x1280 1680x1050
        create_res_2 1920x1200 1792x1120 1680x1050 1536x960 1280x800
        create_res_3 1920x1280 1800x1200 1687x1125 1440x960 1260x788 1080x720 960x640 864x576 768x512
