...
CCC
    ...
    4)
        ...
        ;;
    5)
        create_res_1 3000x2000 2736x1824 2048x1366 1920x1280 1680x1050 1440x900
        create_res_2 1680x1050 1440x900 1280x800 1280x720 960x600 960x540 640x360
        create_res_3 1280x800 1280x720 960x540 840x472 800x450 720x405 640x360 576x324 512x288
        create_res_4 2736x1824 2048x1366 1920x1280 1680x1050 1440x900
        ;;
    6)
        # Scale factors
