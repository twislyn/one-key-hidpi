...
CCC
    ...
    4)
        ...
        ;;
    5)
        create_res_1 3000x2000 2736x1824 2048x1366 1920x1280 1600x1066 1368x912
        create_res_2 1368x912 1280x800 1280x720 960x600 960x540 640x360
        create_res_3 840x472 800x450 720x405 640x360 576x324 512x288 420x234 400x225 320x180
        create_res_4 2736x1824 2048x1366 1920x1280 1600x1066 1368x912
        ;;
    6)
        # Scale factors
